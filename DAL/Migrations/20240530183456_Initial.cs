        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedFamily = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    RegisteredCountPeople = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MeterLocations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MeterName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    MeterNumber = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
