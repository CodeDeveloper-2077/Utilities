...
export class MeterDocumentTableComponent implements OnInit {
  ...
  public meterDocuments: MeterDocumentDto[] = [];
  
  constructor(@Inject('meterDocumentService') protected readonly meterDocumentService: GenericRestService<MeterDocumentDto>) { }
